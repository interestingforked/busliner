...
<p class="pagination">
    ...
    <a href="<?php echo $page->url($first_page) ?>" rel="first">&laquo;&laquo;</a>
	<?php else: ?>
		&laquo;&laquo;
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo $page->url($previous_page) ?>" rel="prev">&laquo;</a>
	<?php else: ?>
            &laquo;
	<?php endif ?>
	...
	<?php if ($next_page !== FALSE): ?>
                        <a href="<?php echo $page->url($next_page) ?>" rel="next">&raquo;&raquo;</a>
	<?php else: ?>
		&raquo;&raquo;
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo $page->url($last_page) ?>" rel="last">&raquo;</a>
	<?php else: ?>
                &raquo;
	<?php endif ?>
